...
(cl:defmethod x1-val ((m <image_points>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader realtime_detect_pkg-msg:x1-val is deprecated.  Use realtime_detect_pkg-msg:x1 instead.")
  (x1 m))

(cl:ensure-generic-function 'x2-val :lambda-list '(m))
(cl:defmethod x2-val ((m <image_points>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader realtime_detect_pkg-msg:x2-val is deprecated.  Use realtime_detect_pkg-msg:x2 instead.")
  (x2 m))

(cl:ensure-generic-function 'x3-val :lambda-list '(m))
(cl:defmethod x3-val ((m <image_points>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader realtime_detect_pkg-msg:x3-val is deprecated.  Use realtime_detect_pkg-msg:x3 instead.")
  (x3 m))

(cl:ensure-generic-function 'x4-val :lambda-list '(m))
(cl:defmethod x4-val ((m <image_points>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader realtime_detect_pkg-msg:x4-val is deprecated.  Use realtime_detect_pkg-msg:x4 instead.")
  (x4 m))

(cl:ensure-generic-function 'y1-val :lambda-list '(m))
(cl:defmethod y1-val ((m <image_points>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader realtime_detect_pkg-msg:y1-val is deprecated.  Use realtime_detect_pkg-msg:y1 instead.")
  (y1 m))

(cl:ensure-generic-function 'y2-val :lambda-list '(m))
(cl:defmethod y2-val ((m <image_points>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader realtime_detect_pkg-msg:y2-val is deprecated.  Use realtime_detect_pkg-msg:y2 instead.")
  (y2 m))

(cl:ensure-generic-function 'y3-val :lambda-list '(m))
(cl:defmethod y3-val ((m <image_points>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader realtime_detect_pkg-msg:y3-val is deprecated.  Use realtime_detect_pkg-msg:y3 instead.")
  (y3 m))

(cl:ensure-generic-function 'y4-val :lambda-list '(m))
(cl:defmethod y4-val ((m <image_points>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader realtime_detect_pkg-msg:y4-val is deprecated.  Use realtime_detect_pkg-msg:y4 instead.")
  (y4 m))
