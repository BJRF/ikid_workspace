...
#define game_controller_DATA_PORT       3838
#define game_controller_RETURN_PORT     3939

#define game_controller_STRUCT_HEADER   "RGme"
#define game_controller_STRUCT_VERSION  12
...
// RoboCupGameControlReturnData structure header
#define game_controller_RETURN_STRUCT_HEADER      "RGrt"
#define game_controller_RETURN_STRUCT_VERSION     2

#define game_controller_RETURN_MSG_MAN_PENALISE   0
#define game_controller_RETURN_MSG_MAN_UNPENALISE 1
#define game_controller_RETURN_MSG_ALIVE          2
...
#ifdef __cplusplus
  // constructor
  RoboCupGameControlReturnData() : version(game_controller_RETURN_STRUCT_VERSION)
  {
    const char* init = game_controller_RETURN_STRUCT_HEADER;
